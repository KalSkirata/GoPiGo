...
/**
 * Synchro Android Database with Raspberry Database
 * First, get Raspberry database data
 * Then truncate the Android database table
 * Add received data to the Android database
 */
